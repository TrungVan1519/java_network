...
public class Client {
	public Client() throws Exception {
		...
		// > Get "Welcome" from server
		// > Note: 
		//		+ Always use println() method intead of using print() method
		//		+ fromServer.readLine() chi co tac dung lay String response truyen tu toClient.println()
		//			ve, khong co tac dung in ra cho client thay nen phai su dung them sout
