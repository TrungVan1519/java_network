...
public class Sender {
	public Sender() throws Exception {
		...
		// > regular socket cua sender dong vai tro gan giong server socket khi duoc chon Port de
		//		gui tin nhan va receiver phai chon Port giong sender, neu khong co thi sender va 
		//		receiver se khong the nhan tin voi nhau
		...
		// Get message
		buffer = new byte[1500]; // MTU (Maximum Transission Unit) = 1500
		packet = new DatagramPacket(buffer, buffer.length);
