...
public class Server {
	...
	public Server() throws IOException {
		...
		//		+ fromClient.readLine() chi co tac dung lay String response truyen tu toServer.println()
		//			ve, khong co tac dung in ra cho server thay nen phai su dung them sout
